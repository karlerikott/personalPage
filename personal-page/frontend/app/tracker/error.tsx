...
export default function TrackerError({
  ...
  return (
    <main className="min-h-screen bg-[#161032] text-white font-[family-name:var(--font-geist-sans)] px-4 pb-12 pt-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white/[0.03] border border-white/5 rounded-xl p-8 flex flex-col items-center gap-4 text-center">
          ...
          <p className="text-white/50 text-sm max-w-sm">Failed to load the tracker. This is usually a temporary issue.</p>
          <button
            onClick={reset}
